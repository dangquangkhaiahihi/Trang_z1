<template>
  ...
  >
      ...
      <tr v-for="col in serverItems" :key="col.AccessID">
        ...
        <td>
            <button class="action-button accept" @click="acceptRequest(col.AccessID)">Accept</button>
            <button class="action-button reject" @click="rejectRequest(col.AccessID)">Reject</button>
        </td>
      </tr>
      </tbody>
